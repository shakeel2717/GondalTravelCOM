    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('iataBalance', function (Ticket $model) {
                return $model->payment_iata - $model->admin_price;
            })
            ...
            ->addColumn('admin_profit_format', function (Ticket $model) {
                return $model->amount - $model->admin_price;
            })
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('ADMIN PROFIT', 'admin_profit_format'),
            ...
            Column::make('IATA BALANCE', 'iataBalance')
                ->sortable()
                ->searchable()
                ->editOnClick()
    ...
    */
    ...
    public function actions(): array
    {
        return [
            ...
            Button::make('print', 'PRINT INVOICE')
