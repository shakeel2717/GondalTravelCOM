            ...
            <tbody>
              <tr>
                <td class="flight">
                  ...
                  <span class="flight-class">{{$data['class']}} <?php if (isset($data['class_type'][$i]['class'])) {
                                                                  echo $data['class_type'][$i]['class'];
                                                                } ?></span>
                </td>
    ...
    <div class="container footer-sec">
      ...
      <table>
        <tr>
          ...
          <td>
            <div class="col-sm" style="text-align:center;">www.gondaltravel.com</div>
          </td>
          <td align="right">
            @if($coll_cash)
            @php
