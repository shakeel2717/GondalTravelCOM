            ...
            <div class="card">
                ...
                <div class="row align-items-center trip-title">
                    <div class="col-5 col-md-auto text-center text-md-left">
                        <h5 class="m-0">{{ $data['from'][0] }}</h5>
                    </div>

                    <div class="col-2 col-md-auto text-8 text-black-50 text-center trip-arrow">➝</div>
                    <div class="col-5 col-md-auto text-center text-md-left">
                        <h5 class="m-0">
                            {{ $data['to'][count($data['to']) - 1] }}</h5>
                    </div>
                    <div class="col-12 col-md-auto text-3 text-dark text-center mt-2 mt-md-0 ml-md-auto">{{$data['takeoffD']}},{{$data['takeoffT']}}-{{$data['landT']}}</div>
                </div>
            </div>
                    ...
                    @for ($i = 0; $i < (int) count($data['to']); $i++)
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4 text-center time-info mt-3 mt-sm-0"> <span
                                    ...
                                    class="text-muted d-block">{{date('d-M-Y', strtotime($data['fromDate'][$i]))}}->{{date('H:i', strtotime($data['fromDate'][$i]))}}</span>
                            </div>
                            <div class="col-12 col-sm-4 text-center time-info mt-3 mt-sm-0"> <span
                                    class="text-5 font-weight-500 text-dark">Arrival</span> <span
                                    class="text-muted d-block">{{date('d-M-Y', strtotime($data['toDate'][$i]))}}->{{date('H:i', strtotime($data['toDate'][$i]))}}</span>
                            </div>
                        </div>
                        <hr>
                        <hr>
