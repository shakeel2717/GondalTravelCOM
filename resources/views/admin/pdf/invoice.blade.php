                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-1">{{ number_format($ticket->received,2) }} €</td>
                        </tr>
                        <tr>
                            <th colspan="2" class="text-end p-1">Le montant restant: </th>
                            <td class="p-1">{{ number_format($ticket->total_amount - $ticket->received,2) }} €</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td>0.00%</td>
                            <td>{{ number_format($ticket->received,2) }} €</td>
                            <td>0.00</td>
                            <td>{{ number_format($ticket->received,2) }} €</td>
                        </tr>
                    </tbody>
