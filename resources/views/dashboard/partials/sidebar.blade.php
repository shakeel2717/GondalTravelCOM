    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li class="{{Request::is('dashboard/admin/finance') ? 'page-active' : ''}}"><a href="{{route('finance.index')}}"><i class="fa fa-shopping-cart mr-2 text-color-1"></i>Finance Management</a></li>
