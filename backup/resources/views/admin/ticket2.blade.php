                                            ...
                                            <div class="single-content-wrap padding-top-60px">
                                                <div id="description" class="page-scroll">
                                                    <div class="single-content-item pb-4">
                                                        <h3 class="title font-size-26">{{$data2['flight_to'][0]}} to </h3>
                                                        <div class="d-flex align-items-center pt-2">
                                                            <p class="mr-2">{{$data2['flight_type']}} Flight</p>
                                                            <p>
                                                                <span class="badge badge-warning text-white font-weight-medium font-size-16">{{($data2['flight_to'])}} Stop</span>
                                                            </p>
                                                        </div>
                    ...
                    <div class="sidebar mb-0">
                        <div class="sidebar-widget single-content-widget">
                            ...
                            <div>
                                ...
                                <br>
                                <a href="{{route('Itinerary', $ticket2->prn_no)}}" class="theme-btn text-center col-lg-12"> Download Receipt</a>

                                 </br>
 
   </br>
    <!--<a href="{{route('downloadticket', $originalticket->ticketimage)}}" class="theme-btn text-center col-lg-12"> Download Reciept</a>-->
   <!--</br>-->
