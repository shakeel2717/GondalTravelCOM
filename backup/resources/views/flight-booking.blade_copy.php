...
@if(isset($data))
 ...
 <div class="form-group">
   ...
   <input id="phone" type="tel"class="form-control" name="contact_no" />
       ...
       "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.js",
                                    ...
                                    @for($i= 0; $i < $data['adult']; $i++)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    <label class="label-text">Given Name</label>
                                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-4 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="gender[]" style="height: 50px" class="form-control"
                                                                id="" required>
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               placeholder="Passport or ID Number" name="pidno[]" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 responsive-column">
                                                    ...
                                                    <div class="content" id="payment-card">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <input type="hidden" class="form-control" name="amount"
                                                                           placeholder="Enter Amount" value="{{$data2['price']}}"/>
                                                                    <label for="card-element mt-1">
                                                                        Enter Card
                                                                    </label>
                                                                    <div id="card-element">
