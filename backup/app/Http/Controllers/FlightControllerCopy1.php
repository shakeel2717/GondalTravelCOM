...
class FlightControllerCopy1 extends Controller
{
    ...
    public function download_Ticket($id)
    {
        ...
        if($collector!=null)
        {
            ...
            if($ticket->format == 'db')
            {
                ...
                $pdf = PDF::loadView('pdf_new',['data'=>$data,'ticket'=>$ticket,'passengers'=>$passengers,'collectorr'=>$collectorr,'pdf'=>True])->setOptions(['defaultFont' => 'sans-serif','images'=>true,])->setPaper('A4', 'portrait');
